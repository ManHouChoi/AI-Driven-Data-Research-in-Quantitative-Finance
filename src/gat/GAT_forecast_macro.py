...
CONFIG = {
    ...
    "heads": 1,
    "dropout": env_float("FYP_GAT_DROPOUT", 0.36878822920584453),
    "lr": env_float("FYP_GAT_LR", 0.006694123858161636),
    "spatial_dim": 16,
    ...
    "weight_decay": env_float("FYP_GAT_WEIGHT_DECAY", 1.9762569165678324e-05),
    "grad_clip": 1.0,
