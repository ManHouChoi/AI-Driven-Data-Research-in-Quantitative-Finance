...
| `outputs/taxonomy/sensitivity/taxonomy_case_study_macro_profiles.csv` | `scripts/generate_sensitivity_report_artifacts.py` | Firm-level taxonomy case-study exposure profiles | Source table for the case-study heat map. |
...
| `report/figures/taxonomy_case_study_macro_profiles.png` | `scripts/generate_sensitivity_report_artifacts.py` | Firm-level taxonomy case-study heat map | Regenerated from annual risk-vector outputs. |
