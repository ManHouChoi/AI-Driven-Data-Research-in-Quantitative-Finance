...
\begin{figure}[!htbp]
    ...
    \caption*{\textbf{OOS forecasting comparison.} Meso ST-GAT is the strongest
    verified specification against the identity baseline on the exported
    2021--2024 review panel.}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \caption*{\textbf{Graph-density diagnostic.} The Macro graph is much denser,
    while the Meso graph keeps sparse, high-confidence textual-risk peer links.}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \caption*{\textbf{Portfolio ranking diagnostic.} The Meso ST-GAT return-only
